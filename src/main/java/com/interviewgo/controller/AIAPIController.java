...
import com.interviewgo.service.LocalAIService;
...
public class AIAPIController {
	...
	public Map<String, Object> chatResponseAPI(@RequestParam(value="query") String q) {
	...
	// chat model + tts 처리
	@PostMapping("/tts-api")
	public Map<String, Object> ttsResponseAPI(@RequestParam(value="query") String q) throws Exception {
		// AI 답변 변수
		String answer;
	...
	// Local API 모드
	// 로컬 채팅 모드
	@PostMapping("/chat-local")
	public String chatResponseLocal(@RequestParam(value="query") String q) {
		LocalAPIDTO.Gemma response = aiservice.askGemma(q);
		
		return response.getAnswer();
	}
	
	// 로컬 TTS 처리
	@PostMapping("/tts-local")
	public Map<String, Object> ttsResponseLocal() {
		return null;
	}
}
